...
export const buildSocratesReconciliationCheckpoint = (input: {
  ...
  "Durable change means a material goal or scope change, a future-dependent decision, a verified build or test milestone, a blocker or incomplete handoff, or the final restart state. Only then read the exact socrates://project/memory, notes, or repo-docs resource, apply the smallest targeted edit, and re-read that same URI to verify it. Never append a competing authority path.",
