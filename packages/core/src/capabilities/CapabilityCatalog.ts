...
const serviceCapabilities: CapabilityDefinition[] = [
  ...
  serviceCapability("context.user_approved_compaction", "context_stage", "Apply a specifically user-approved lossy context transformation while retaining exact provenance.", "context.compact_with_consent", ALL_AGENT_ROLES, ["turn", "conversation", "global"], "packages/core/src/context/contextCompression.ts", "migration_compatibility"),
  ...
  serviceCapability("worker.context_compactor", "structured_worker", "Produce a user-approved context derivative through the shared runtime.", "agent.context_compactor", ["socrates_context_compactor", "memory_context_compactor", "context_anchor_repair"], ["conversation", "global"], "packages/core/src/agent/CompressorAgent.ts", "migration_compatibility"),
