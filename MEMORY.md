...
- Next build on the unified lifecycle toward the global no-project product surface: global resource scopes and Paths/Selected/Full access, the direct seamless landing/header/sidebar experience, and one canonical global current-goal pointer while preserving existing user data through narrow compatibility adapters.
